...
public class PaymentController {
	...
	public String createOrder() {
		Order order = null;
		try {
			RazorpayClient razorpay = new RazorpayClient("rzp_test_8BpziH3h3pFM1Z", 
					"v0HxsLR7fbp84XRjxgJOmE4V");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
			...
			RazorpayClient razorpayClient = new RazorpayClient("rzp_test_8BpziH3h3pFM1Z", 
	        								"v0HxsLR7fbp84XRjxgJOmE4V");
